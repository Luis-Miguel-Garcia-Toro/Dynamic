...
const SearchBar = () => {
    const { getProductsSearch, listProducts, loadingProducts, isSearching, findFilter, onClickOutside, configPages } = useSearch();
    ...
    const handleSearch = () => {
      ...
      console.log(configPages.images.no_found_product)
                                            ...
                                            <div className={Styles.productContainer}>
                                                <div>
                                                    <img
                                                        ...
                                                        onError={(e) => {
                                                            e.target.src = configPages.images.no_found_product
                                                        }}
                                                    />
                                                </div>
                                                <div>
                                                    ...
                                                    {product.item.countSuggested ? (
                                                        <div>Cantidad Sugerida : {product.item.countSuggested}</div>
                                                    ) : null}
                                                    <b>
                                                        {' $' +
