...
import Styles from "./scss/card-product-suggested.module.scss"
import { useCardProduct } from "./view-model/useCardProduct"
import {useEcommerceStore} from '../../../../../../common/infrastructure/store'

export const CardProductSuggested = ({
  product,
  type,
  contentClassName,
  sizeCardRow,
...
CardProductSuggested.propTypes = {
...
CardProductSuggested.defaultProps = {
  type: "vertical",
  sizeCardRow: "medium",
};
