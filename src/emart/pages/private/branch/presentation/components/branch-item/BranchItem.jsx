...
export const BranchItem = ({ branch, colorBusiness }) => {
  ...
  const orders = [
    { document: 1234678, created_at: '2022-01-01', end_date: '2022-05-01', total: 150000, pending_value: 100000 },
    { document: 5678940, created_at: '2023-01-01', end_date: '2023-05-01', total: 180000, pending_value: 130000 },
  ]
  ...
  return (
    <>
      <div className={`${Styles.BranchItemContainer} fadeIn`} key={code} onClick={() => setOpen(true)}>
                      ...
                      <StyledTableRow key={row.document}>
                        ...
                        <StyledTableCell align="center">
                          <input
                            ...
                            type="number"
                            min={0}
                            onChange={e =>handleChange(e.target.value, row.document)}
                            placeholder="0"
                          />
                        </StyledTableCell>
                      </StyledTableRow>
